...
#include <stdlib.h> //biblioteca de alocação de espço de memória
#include <locale.h> //biblioteca de alocações de texto por região 
#include <string.h> //biblioteca responsavel por cuidar do string

int registro() // função responsável po cadastrar os usuarios no sistema
{
